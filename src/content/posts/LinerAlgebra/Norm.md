...
具体的[L1,L∞推导过程](https://v1otusc.github.io/2020/06/01/Induced-Matrix-Norms-%E8%AF%B1%E5%AF%BC%E7%9F%A9%E9%98%B5%E8%8C%83%E6%95%B0%E8%AF%81%E6%98%8E/)和
...
- 三角不等式 ：对于任何两个**同型矩阵** $A$ 和 $B$，$\|A + B\|_F \leq \|A\|_F + \|B\|_F$。
...
- 矩阵范数的相容性（Compatibility）或**次可乘性**（Sub-multiplicativity）:两个矩阵乘积的范数，总是小于或等于这两个矩阵各自范数的乘积。$\|\|AB\|_F \leq \|\|A\|_F \cdot \|\|B\|_F$
