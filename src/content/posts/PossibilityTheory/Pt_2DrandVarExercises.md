...
eg2: 设X，Y在G上服从均匀分布，$G={x\in(0,4)|y<\frac{1}{4}x}$
...
\end{cases}\\
f_X(x)=\begin{cases}
    \int_0^{\frac{x}{4}}\frac{1}{2}dy=\frac{x}{8} & x\in(0,4),0<y<\frac{x}{4}\\
    0 & \text{其他}
\end{cases}\\
f_Y(y)=\begin{cases}
    \int_{4y}^4\frac{1}{2}dx=2-2y & 0\leq y\leq 1\\
    0 & \text{其他}
\end{cases}\\
\text{显然，不独立}
$$
...
$$
f(x,y)=\frac{1}{2\pi\sigma_1\sigma_2}\operatorname{exp}\left{-\frac{1}{2}\left[\frac{(x-\mu_1)^2}{\sigma_1^2}+\frac{(y-\mu_2)}{\sigma_2^2}\right]\right}\\
