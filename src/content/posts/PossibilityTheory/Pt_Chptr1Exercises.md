...
&P(ABC)=0\\
&P(A\cup B\cup C)\\
&=P(A)+P(B)+P(C)-P(AB)-P(AC)-P(CB)+P(ABC)\\
&=3x-3x^2\\
&P(A\cup B)=P(A)+P(B)-P(AB)\\
&=2x-x^2\\
&\because A\cup B\sub A\cup B\cup C\\
...
&=\frac{m}{m+n}(\frac{1}{2})^r+\frac{n}{m+n}\cdot1\\
...
&P(Y=L)=\sum_{k=L}^{\infin}P(Y=L|X=k)P(X=k)\\
&=\sum_{k=L}^{\infin}C_k^Lp^L(1-p)^{K-L}\cdot\frac{\lambda^ke^{-\lambda}}{k!}\\
&=\sum_{k=L}^{\infin}\frac{k!}{L!(K-L)!}p^L(1-p)^{K-L}\cdot\frac{\lambda^ke^{-\lambda}}{k!}\\
&=\frac{p^Le^{-\lambda}}{L!}\sum_{k=L}^{\infin}\frac{(1-p)^{k-L}\lambda^{k-L}\cdot\lambda^L}{(k-L)!}\\
&e^x=\sum_{n=0}^{\infin}\frac{n}{x^n}\\
&P(Y=L)=\frac{(\lambda p)^L e^{-\lambda}}{L!}\cdot e^{\lambda(1-p)}\\
&=\frac{(p\lambda)^L e^{-p\lambda}}{L!}
\end{align*}
$$
:::
