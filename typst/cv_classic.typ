...
#show: ilm.with(
  title: [计算机视觉 开卷考试速查手册 — 传统视觉篇],
  authors: "Biscuit · Alkaid",
  date: datetime(year: 2026, month: 07, day: 05),
  abstract: [
    本文档为《计算机视觉》传统视觉部分速查，涵盖：Lecture 02 空间图像增强（灰度变换、直方图均衡化/CLAHE、算术运算）、Lecture 03 图像滤波（卷积/互相关、平滑/锐化滤波、Canny 边缘检测）、Lecture 04 特征检测（Harris 角点、LoG 斑点、SIFT）、Lecture 05 拟合与变换（最小二乘法、RANSAC、霍夫变换）、Lecture 07 图像分割（传统方法、深度学习分割、检测演进）、Lecture 08–09 成像系统（ISP 流程、HDR、图像复原、传感器、底层视觉任务）、Lecture 11 光流（LK、HS、KLT 跟踪器），以及【补1】【补2】【补3】【补5】【补6】【补8】共 6 个补充章节。适合开卷考试快速查阅。
  ],
